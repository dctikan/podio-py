...
import urllib.parse, re, os, mimetypes
try:
...
class MultipartParam(object):
    ...
    def __init__(self, name, value=None, filename=None, filetype=None,
        ...
        if filename is None:
            ...
            self.filename = ''.join(map(chr, self.filename.encode("unicode_escape"))).\
                    replace('"', '\\"')
